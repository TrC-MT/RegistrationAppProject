        ...
        <>
            <div className='table-box'>
                ...
                <table id="courses-table">
                    ...
                    <tbody>
                        <CoursesTableTags render={{courses: pieces.courses, filter: pieces.filter, num: pieces.num, sn: pieces.sn, nm: pieces.nm, scra: pieces.scra, sar1: pieces.sar1, sar2: pieces.sar2, stu: pieces.stu, setMsg: pieces.setMsg}}></CoursesTableTags>
                    </tbody>
                </table>
            </div>
        </>
